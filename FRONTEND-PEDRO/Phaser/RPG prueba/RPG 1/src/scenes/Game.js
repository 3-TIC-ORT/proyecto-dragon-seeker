...
export class Game extends Phaser.Scene {
  ...
  create(data) {
    ...
    const carteles_inferior = map.createLayer(
      "carteles_inferior",
      allTilesets,
      0,
      0,
    ...
    carteles_inferior.setCollisionByExclusion([-1]);
    carteles.setDepth(1.5);
    ...
    this.physics.add.collider(this.player, carteles_inferior);
      ...
      postEvent("verificarAccesoZonaBoss", { idpartida }, (res) => {
        ...
        if (res.puedePasar) {
          this.dialogo.confirmar(
            ...
            "¿Querés entrar al bosque dorado?",
            () => {
              this.cambiandoEscena = true;
